...
namespace CoreCodeCamp.Controllers
{
    ...
    public class CampsController : ControllerBase
    {
        ...
        // don't need [FromBody] because of the APIController attribute, will automatically do model binding from body
        ...
        public async Task<ActionResult<CampModel>> Put(string moniker, CampModel model)
        {
            try
            {
                ...
                // merges incoming model object with existing oldCamp object
